...
TaskIsCompleted.args = {
    ...callbackProps,
    task: { id: '5', title: "isCompleted", completed: true, addedDate: '', deadline: '', description: '', order: 0, priority: 2, startDate: '', status: 1, todoListId: "todolistId1"  },
    todolistId: 'todolist1',
}
export const TaskIsNotCompleted = Template.bind({});
TaskIsNotCompleted.args = {
    ...callbackProps,
    task: { id: '6', title: "isNotCompleted", completed: false, addedDate: '', deadline: '', description: '', order: 0, priority: 2, startDate: '', status: 3, todoListId: "todolistId1"  },
    todolistId: 'todolist1'
}
